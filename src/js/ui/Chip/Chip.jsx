...
const Chip = React.forwardRef((props, ref) => {
  ...
  if (onDelete) {
    const customClasses = clsx({
      'chip--deleteIconSmall': small,
      [`chip--deleteIconColor${capitalize(color)}`]:
         color !== 'default' && variant !== 'outlined',
      [`chip--deleteIconOutlinedColor${capitalize(color)}`]:
         color !== 'default' && variant === 'outlined',
    });

    deleteIcon = deleteIconProp && React.isValidElement(deleteIconProp) ? (
      React.cloneElement(deleteIconProp, {
        className: clsx(deleteIconProp.props.className, 'chip--deleteIcon', customClasses),
  ...
  return (
    <Component
      ...
      className={clsx(
        'chip',
        {
          ...
          'chip--sizeSmall': small,
          [`chip-color-${color}`]: color !== 'default',
          'chip--clickable': clickable,
          [`chip--clickableColor${capitalize(color)}`]: clickable && color !== 'default',
          'chip--deletable': onDelete,
          [`chip--deletableColor${capitalize(color)}`]: onDelete && color !== 'default',
          'chip--outlined': variant === 'outlined',
          'chip--outlinedPrimary': variant === 'outlined' && color === 'primary',
          'chip--outlinedSecondary': variant === 'outlined' && color === 'secondary',
        },
        className,
      )}
    ...
    >
      {avatar || icon}
      <span
        className={clsx('chip--label', {
          'chip--labelSmall': small,
        })}
      >
        {label}
      </span>
