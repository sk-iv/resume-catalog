...
const ListItem = React.forwardRef((props, ref) => {
  ...
  const componentProps = {
    className: clsx(
      'list-item',
      {
        'list-item--dense': childContext.dense,
        'list-item--gutters': !disableGutters,
        'list-item--divider': divider,
        'list-item--disabled': disabled,
        'list-item--button': button,
        'list-item--alignItemsFlexStart': alignItems === 'flex-start',
        'list-item-hasSecondaryAction': hasSecondaryAction,
  ...
  if (button) {
    ...
    componentProps.focusVisibleClassName = clsx('list-item--focusVisible', focusVisibleClassName);
