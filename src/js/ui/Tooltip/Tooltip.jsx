...
const Tooltip = React.forwardRef((props, ref) => {
  ...
  return (
    <>
      ...
      <Popper
        className={clsx('popper', {
          'popper-popperInteractive': interactive,
          'popper-popperArrow': arrow,
        })}
        placement={placement}
        anchorEl={childNode}
          ...
          >
            <div
              className={clsx(
                'tooltip',
                {
                  'tooltip-touch': ignoreNonTouchEvents.current,
                  'tooltip-tooltipArrow': arrow,
                },
                [`tooltipPlacement-${capitalize(placementInner.split('-')[0])}`],
              )}
            >
              {title}
              {arrow ? <span className="tooltip-arrow" ref={setArrowRef} /> : null}
            </div>
          </TransitionComponent>
        )}
      </Popper>
