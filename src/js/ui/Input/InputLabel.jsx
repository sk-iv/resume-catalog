...
if (process.env.WEBPACK || process.env.STORYBOOK_DATA_KEY == '1') { require('./InputLabel.css'); }
  ...
  return (
    <FormLabel
      ...
      className={clsx(
        'label-input',
        {
          'label-formControl': muiFormControl,
          'label-animated': !disableAnimation,
          'label-shrink': shrink,
          'label-marginDense': fcs.margin === 'dense',
        },
        className,
      )}
      classes={{
