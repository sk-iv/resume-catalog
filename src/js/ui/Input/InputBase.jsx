...
if (process.env.WEBPACK || process.env.STORYBOOK_DATA_KEY == '1') { require('./input.css'); }
  ...
  return (
    <div
      className={clsx(
        classes.root,
        {
          'input--disabled': fcs.disabled,
          'input--error': fcs.error,
          'input--fullWidth': fullWidth,
          'input--focused': fcs.focused,
          'input--formControl': muiFormControl,
          'input--marginDense': fcs.margin === 'dense',
          'input--multiline': multiline,
          'input--adornedStart': startAdornment,
          'input--adornedEnd': endAdornment,
        },
        classNameProp,
      )}
      onClick={handleClick}
      ...
      <FormControlContext.Provider value={null}>
        <InputComponent
          ...
          className={clsx(
            ...
            {
              'input--disabled': fcs.disabled,
              'input--inputTypeSearch': type === 'search',
              'input--inputMultiline': multiline,
              'input--inputSelect': select,
              'input--inputMarginDense': fcs.margin === 'dense',
              'input--inputHiddenLabel': fcs.hiddenLabel,
              'input-adornedStart': startAdornment,
              'input--inputAdornedEnd': endAdornment,
            },
            inputPropsClassName,
          )}
